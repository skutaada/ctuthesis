...
\\
Sparse to dense RGBD offers a decrease in mAP and Recall but provides overall the best Precison out of any method tested. Sparse to dense network output time is slowing down the inference speed by only a small amount.\\
\\
