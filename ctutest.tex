...
\end{figure}
\chapter{Results}
After the training completed the different metrics on the validation dataset will be compared. These metrics include:
\begin{itemize}
	\item Precision
	\item Recall
